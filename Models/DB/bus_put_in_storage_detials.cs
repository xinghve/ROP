...
namespace Models.DB
{
    ...
    /// 
    /// </summary>
    public class bus_put_in_storage_detials
    {
        /// <summary>
        /// 
        /// </summary>
        public bus_put_in_storage_detials()
        {
        }
        ...
        /// 入库数量（采购单位）
        /// </summary>
        public System.Decimal buy_num { get { return this._buy_num; } set { this._buy_num = value; } }
