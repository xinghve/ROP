...
namespace Tools
{
    public class MetarnetRegex
    {
        ...
        /// <param name="Text"></param>
        /// <returns></returns>
        public static string SHA384Encrypt(string Text)
        {
            var bytes = Encoding.Default.GetBytes(Text);
        ...
        {
            Regex regex = new Regex(@"((^13[0-9]{1}[0-9]{8}|^15[0-9]{1}[0-9]{8}|^14[0-9]{1}[0-9]{8}|^16[0-9]{1}[0-9]{8}|^17[0-9]{1}[0-9]{8}|^18[0-9]{1}[0-9]{8}|^19[0-9]{1}[0-9]{8})|^((\d{7,8})|(\d{4}|\d{3})-(\d{7,8})|(\d{4}|\d{3})-(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1})|(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1}))$)");
            return regex.IsMatch(input);
